...
RP2040-ZeroはPCB裏面に載せ、端子とスイッチは表に向くように表面実装します。GNDが長方形、3V3と5Vが面取り長方形になっているため、これに揃えます。  
...
最後にRP2040をはんだづけします。図のように基板の裏から切り欠きに合わせて乗せ、パッドに合わせて実装します。  
マスキングテープ等で位置を固定するようにしてください。
