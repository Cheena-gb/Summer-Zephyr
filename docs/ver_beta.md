...
- その他ファンクションキー3個
  ...
  <details><summary>キーキャップセットで全部揃えられるものはある？</summary>日本語配列用キーキャップセット「Acid Caps」を使用するとすべて間違いなく揃えることができます(とはいえ、Spaceの左右幅を揃えるのは難しかったはずです)。これ以外に、明確にすべて揃えることができるセットは把握していません。</details>
